    ...
    private fun renewItems(view: View?) {
        ...
        for (i in 0..9) {
            ...
            if (i % 5 == 0) {
                ...
                sliderItem.imageUrl = "https://khuyenmaiviet.vn/wp-content/uploads/2019/11/76793129_2285972111511566_282390569248882688_o.jpg"
            }else if(i%5==3){
                sliderItem.imageUrl = "https://hoaanhdao.vn/2019_img/files/san-pham/640x340-mobile%20(1).png"
            }else {
                sliderItem.imageUrl = "https://img.kam.vn/images/414x0/ed264b973dda4ee5b852f77e93f724b1/dong-ho-duy-anh-dong-ho-nhat-sale-off-15.jpg"
            }
